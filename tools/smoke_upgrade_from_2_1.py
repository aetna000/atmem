#!/usr/bin/env python3
"""Create a published-version fixture, then prove the current release upgrades it safely."""
...
def verify_upgrade(root: Path) -> None:
    ...
    print(f"AtMem persisted-state -> {expected_atmem} upgrade smoke test passed")
