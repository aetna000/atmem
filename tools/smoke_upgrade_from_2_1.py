#!/usr/bin/env python3
"""Create a published-version fixture, then prove 2.2.6b11 upgrades it safely."""
...
def verify_upgrade(root: Path) -> None:
    ...
    assert importlib.metadata.version("atmem") == "2.2.6b11"
    ...
    print("AtMem persisted-state -> 2.2.6b11 upgrade smoke test passed")
