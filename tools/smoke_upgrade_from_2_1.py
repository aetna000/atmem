#!/usr/bin/env python3
"""Create a published-version fixture, then prove 2.2.7b1 upgrades it safely."""
...
def create_fixture(root: Path) -> None:
    ...
    assert manifest["source_version"] in {"2.1.0", "2.2.3", "2.2.4", "2.2.5", "2.2.6"}
...
def verify_upgrade(root: Path) -> None:
    ...
    assert importlib.metadata.version("atmem") == "2.2.7b1"
    ...
    print("AtMem persisted-state -> 2.2.7b1 upgrade smoke test passed")
