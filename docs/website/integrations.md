...
## Compatibility
AtMem is 2.3.6 and the OpenClaw bridge is 2.3.6; AtBot remains 0.1.0. The locked OpenClaw
...
coverage as OpenClaw. See [release compatibility](../releases/v2.3.6.md).
