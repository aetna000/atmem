...
AtFlows is installed with AtMem 2.3.7. `atmem init` starts its local server, while trace collection and review are opt-in.
...
[2.3.7 release note](../releases/v2.3.7.md) for limits and setup.

## Upgrade and recovery
Follow the [2.3.7 release commands](../releases/v2.3.7.md) and
