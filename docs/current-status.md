...
Repository metadata is **2.2.6b7** and the matched OpenClaw bridge is
...
- The release workflow creates persisted data with public AtMem 2.1.0, 2.2.3,
  2.2.4, and 2.2.5, upgrades each environment to 2.2.6b7, and verifies record identity, recall, audit
