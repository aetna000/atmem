...
**Release line:** AtMem `2.3.0`, OpenClaw bridge `2.3.0`, AtBot
`0.1.0a6`.

AtMem 2.3.0 is the stable local encrypted Agent Black Box and governed-memory
...
The 2.3.0 home is a local, single-writer design. It does not implement cloud sync,
...
See the [2.3.0 release notes](releases/v2.3.0.md) for upgrade and migration commands,
