...
Bridge `2.2.7-beta.1` includes exact task-context delivery, the shared
...
### Delegated local CLI identity and tool evidence in 2.2.7b1
...
Beta 2.2.7b1: automatic recall now requires calibrated direct
