...
**Created**: 2026-09-09
**Status**: The bounded standalone full-fidelity OpenClaw profile ships in stable
2.3.0. Broader cross-framework capture, configurable capacity/backpressure and
the remaining T042–T053 acceptance matrix stay open and are not claimed by that
release.
