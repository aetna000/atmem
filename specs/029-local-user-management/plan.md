...
Legacy test bearer tokens remain accepted by `/v1/evidence` for 2.3 compatibility and
...
This is additive in stable 2.3.0. Existing installs must run `atmem init`; evidence is
